...
ADJECTIVES: list = ["hilarious", "exhausting", "boring", "exciting", "weird", "fun", "tiring", "fulfilling"]
ACTIONS: list = ["found", "read", "tried", "shared", "grabbed", "designed", "played", "created"]
TOPICS: list = ["a map", "a book", "a snack", "a trick", "a story", "a sport", "a meal"]
...
def generate_messages():
    ...
    while True:
        ...
        yield f"During my free time I {action} {topic}! It was {adjective}."
